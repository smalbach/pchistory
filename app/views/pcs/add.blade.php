...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        {{ Field::text('type','',['readonly'=>'readonly','class'=>'form-control','id'=>'type','data-rule-required'=>'true','placeholder'=>'Click para agregar Tipo']) }}
        {{ Field::hidden('type_id',"",['id'=>'type_id']) }}


        {{ Field::text('location','',['readonly'=>'readonly','class'=>'form-control','id'=>'location','data-rule-required'=>'true','placeholder'=>'Click para agregar Ubicaciónn']) }}
        {{ Field::hidden('location_id',"",['id'=>'location_id']) }}


        {{ Field::text('owner','',['readonly'=>'readonly','class'=>'form-control','id'=>'owner','data-rule-required'=>'true','placeholder'=>'Click para agregar Responsable']) }}
        {{ Field::hidden('owner_id',"",['id'=>'owner_id']) }}


        {{ Field::text('active_type','',['readonly'=>'readonly','class'=>'form-control','id'=>'active_type','data-rule-required'=>'true','placeholder'=>'Click para agregar tipo activo']) }}
        {{ Field::hidden('active_type_id',"",['id'=>'active_type_id']) }}
        ...
        {{ Field::text('access_number','',['class'=>'form-control']) }}

        {{ Field::text('amount','1',['class'=>'form-control']) }}
    ...
    <div class="col-lg-6">
        ...
        {{ Field::text('maintenance_freq','',['class'=>'form-control','id'=>'maintenance_freq']) }}
        ...
        {{ Field::text('waranty','',['class'=>'form-control']) }}

        {{ Field::text('waranty_end','',['class'=>'form-control','id'=>'waranty_end']) }}
        ...
        {{ Field::text('vendor','',['class'=>'form-control']) }}
        ...
        {{ Field::text('state','bueno',['class'=>'form-control']) }}

        {{ Field::hidden('order','10',['class'=>'form-control']) }}
