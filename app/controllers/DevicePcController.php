...
use PcHistory\Repositories\DevicePcRepo as apRepo;
use PcHistory\Managers\DevicePcManager ;

class DevicePcController extends BaseController{
    ...
    public function add_pc(){
        $acpc = $this->apRepo->newDevice();


        $manager = new  DevicePcManager($acpc,Input::all());
